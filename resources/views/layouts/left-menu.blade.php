                    ...
                    <div class="file-case-content user-dashboard-file-case">
                        <div class="left-side">
                            <div class="item">
                                ...
                                <div class="note">Please note that all fields below are mandatory and you must attach at least one document.</div>
                            </div>
                        </div>
                        <div class="right-side w-100" id="arbitration-rules-content">
                            ...
                            <form action="" class="file-case-form">
                                ...
                                <div class="form-item w-100">
                                    <textarea name="message" id="message" placeholder="Message" class="message w-100" required=""></textarea>
